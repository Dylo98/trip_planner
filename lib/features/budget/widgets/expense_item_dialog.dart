...
class ExpenseItemDialog extends ConsumerStatefulWidget {
  ...
  final String? tripId;
  @override
  ConsumerState<ExpenseItemDialog> createState() => _ExpenseItemDialogState();
}

class _ExpenseItemDialogState extends ConsumerState<ExpenseItemDialog> {
  ...
  Widget build(BuildContext context) {
    ...
    return AlertDialog(
      title: Text(_isEditMode ? 'Edytuj wydatek' : 'Dodaj wydatek'),
